...
class serialPlot:
    def __init__(self, serialPort='COM14', serialBaud=115200, plotLength=100, dataNumBytes=8, numPlots=3): 
        ...
        self.dataType = None
        if dataNumBytes == 4:
            self.dataType = 'f'     # i = 4 byte integer (signed short), f = 4 byte float
        elif dataNumBytes == 8:
            self.dataType = 'd'     # d = 8 byte float, q = double integer, 
        self.data = []
