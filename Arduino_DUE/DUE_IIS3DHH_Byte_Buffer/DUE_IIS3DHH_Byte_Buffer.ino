...
// Real-time graphical data streaming using "RealTime_3Axis_Stream.py"
...
//  SerialUSB.println(zAcc, 0);
  ...
  byte* xAccl = (byte*)(xAccl);
  byte* yAccl = (byte*)(yAccl);
  byte* zAccl = (byte*)(zAccl);
  byte buf[24] = {xAccl[0], xAccl[1], xAccl[2], xAccl[3], xAccl[4], xAccl[5], xAccl[6], xAccl[7],
                 yAccl[0], yAccl[1], yAccl[2], yAccl[3], yAccl[4], yAccl[5], yAccl[6], yAccl[7],
                 zAccl[0], zAccl[1], zAccl[2], zAccl[3], zAccl[4], zAccl[5], zAccl[6], zAccl[7]};
...
//  zAcc = zVal * SCALE;
  ...
  byte xAccl = xVal * SCALE;
  byte yAccl = yVal * SCALE;
  byte zAccl = zVal * SCALE;
}
